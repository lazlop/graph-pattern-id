...
plt.xlabel("Original Graph Size (Triples)")
plt.ylabel("Compressed Graph Size (Triples)")
plt.title(f"Mortar Building Compression By Graph Size")
plt.legend()
...
plt.title(f"Mortar Building Compression Ratio By Graph Size")
plt.legend()
