...
def create_new_graph(triples, ns = EX):
    ...
    for class_triple, triple in triples:
        ...
        store.add(Quad(NamedNode(ns[s]), NamedNode(triple.p), NamedNode(ns[o]), NamedNode(ns)))
        store.add(Quad(NamedNode(ns[s]), NamedNode(A), NamedNode(class_triple.s), NamedNode(ns)))
        store.add(Quad(NamedNode(ns[o]), NamedNode(A), NamedNode(class_triple.o), NamedNode(ns)))
    return group_dict
